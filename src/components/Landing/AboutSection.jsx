...
import img2 from '../../assets/yogi_balu (4).webp';
import img3 from '../../assets/yogi_balu (2).webp';
import img4 from '../../assets/yogi_balu (5).webp';
import img5 from '../../assets/Studio.webp';
...
const aboutImg4 = img4;
const aboutImg5 = img5;
...
export default function AboutSection() {
  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth < 768) {
        setSwiperDims({ width: 280, height: 370 });
  ...
  return (
    <section id="about" ref={sectionRef} className="px-4 md:px-12 lg:px-20 py-16 md:py-32 max-w-7xl mx-auto">
